...
<Library LVVersion="24008000">
	...
	<Item Name="controls" Type="Folder">
		<Item Name="error field names.ctl" Type="VI" URL="../controls/error field names.ctl"/>
		<Item Name="error metadata mini.ctl" Type="VI" URL="../controls/error metadata mini.ctl"/>
		<Item Name="error metadata.ctl" Type="VI" URL="../controls/error metadata.ctl"/>
	</Item>
